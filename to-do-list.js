...
function renderTodoList(){
    ...
    for(let i=0;i<todoList.length;i++){
        ...
        todoListHTML+=html;
        //here we are just generating the html, the button is still not on the page yet
        

    }
    //this code is for putting the button "on the page"-->after that only u can add eventlistenerr
